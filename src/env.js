...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_CLOUD_ENVIRONMENT: z.enum(["global", "usgov", "usgovdod", "germany", "china"]).default("global"),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_CLOUD_ENVIRONMENT: process.env.NEXT_PUBLIC_CLOUD_ENVIRONMENT,
  },
  /**
